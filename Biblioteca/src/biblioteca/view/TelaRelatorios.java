...
public class TelaRelatorios extends JFrame {
        ...
        try {
            switch (tipoRelatorio) {
                case REL_EMP_MES:
                    ...
                    relatorioController.gerarRelatorioEmprestimosMes(
                            mesSelecionado, anoSelecionado, caminhoArquivo);
                    break;

                case REL_OBRAS_MAIS_EMP:
                    relatorioController.gerarRelatorioObrasMaisEmprestadas(caminhoArquivo);
                    break;

                case REL_USUARIOS_ATRASO:
                    relatorioController.gerarRelatorioUsuariosComMaisAtrasos(caminhoArquivo);
                    break;
            }
    ...
    public static void main(String[] args, BibliotecaController controller) {
