...
public class UsuarioDAO implements Persistivel<Usuario> {
    private static final String CAMINHO_PASTA = "dados";
    ...
    public boolean removerComRetorno(String id) {
        boolean removido = listaDeUsuarios.removeIf(u -> u.getMatricula().equals(id));
        if (removido) {
            salvarDados();
        }
        return removido;
